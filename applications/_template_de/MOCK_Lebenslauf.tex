...
%   Multi-page:  L=date, C=label1/label2/label3, R=Seite n von N
...
\tagline{
	...
	% Full:  \address{Hauptstraße 101}{D-12345}{Berlin}{Deutschland}
	% City+: \address{Hauptstraße 101}{D-12345}{Stadt}{Deutschland}  → visual "Berlin, Deutschland"
	% DE apps often omit country: \address{Hauptstraße 101}{D-12345}{Stadt}{Deutschland}
...
%===============================================================================
	...
	\highlightbar{%
		...
		\cvLang{Deutsch / Englisch}{5}
		\cvLang{Französisch}{3}
	...
	% Optional: ATS sidebar summary — fallback for extractors that ignore
	% content-stream order. Uncomment to force a single-block sidebar in pdftotext.
	% \sidebarATSSummary{%
	% 	Kenntnisse. Programmiersprachen: LaTeX (Experte), ...
	% }
	...
	% Optional: ATS sidebar summary for page 2.
	% \sidebarATSSummary{%
	% 	Methodenprofil. Methodik 1: Skill 1, ...
	% }
...
\fullbar{
	...
	\section[\faProjectDiagram]{Ausgewählte Projekte \& Open Source}

	% \cvExpDetail{context}{title}{date}[icon]{meta}{bullets}[tags]
	\cvExpDetail
	{Kontext 1 | Kategorie}
	{Projekttitel 1}
	{01|2026\textendash Aktuell}
	[\faGithub]
	{beispielnutzer/projekt-1}
	{
		\cvDetailItem{Optional:}
		{Kurzbeschreibung des Projekts und der Zielsetzung.}
		\cvDetailItem{Optional:}
		{Weitere Details zu Umsetzung, Umfang oder Ergebnis.}
	}
	[{
